...
## 2025-12-13 03:12 - /mnt/d/Python Projects/obby/notes/Terminal fix.md

- **projects**: windsurf, cursor, Cascade
- **concepts**: terminal fix, shell integration, settings.json, cursor lag issues

---

## 2025-12-13 03:13 - /mnt/d/Python Projects/obby/notes/Store list.md

- **todos**: Watermelon, Strawberries, Pork chops, Kale salad, Hot dog buns (+6 more)

---

## 2025-12-13 03:13 - /mnt/d/Python Projects/obby/notes/Ant stuff.md

- **concepts**: Advion, Terro, borax-based solutions

---

## 2025-12-13 03:13 - /mnt/d/Python Projects/obby/notes/Backpacking list thoughts.md

- **projects**: Backpacking
- **concepts**: Food supplies, Camping gear, Clothing
- **dates**: Day 1

---

## 2025-12-13 03:13 - /mnt/d/Python Projects/obby/notes/App ideas.md

- **projects**: Book swiping app, Task management app with AI summaries, Diff viewer auto-update feature, Note-taking app with semantic search
