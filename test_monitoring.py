...
def test_monitoring():
    ...
    print("\nSummary:")
    print(f"- Real-time detection: {'✓' if real_time_events else '✗'}")
    print(f"- Periodic detection: {'✓' if len(all_events) > len(real_time_events) else '✗'}")
    print(f"- Both modes working: {'✓' if real_time_events and all_events else '✗'}")
