...
"""
        ...
        options = ClaudeAgentOptions(
            ...
            system_prompt=(
                ...
                " You have access to a SQLite database (.db/obby.db) containing AI-generated semantic insights about the user's notes."
                ...
                "\n\nExample queries:"
                "\n- List insights: sqlite3 .db/obby.db \"SELECT id, insight_type, title, summary FROM semantic_insights WHERE status != 'dismissed' ORDER BY priority DESC LIMIT 10\""
                "\n- Active todos: sqlite3 .db/obby.db \"SELECT entity_value, note_path FROM note_entities WHERE entity_type = 'todo' AND status = 'active'\""
                "\n- Get insight by ID: sqlite3 .db/obby.db \"SELECT * FROM semantic_insights WHERE id = 5\""
                "\n\nFile References:"
